...
\begin{align*}
  \overline{YLD}_{acro,bas,cty,water}
  &= \overline{YLDBASE}_{acro,bas,cty,water}
     \cdot \overline{YLDTECH}_{acro,bas,cty,water}
     \\
  &\quad
     \cdot \overline{YLDCHAN}_{acro,bas,cty,water}
     \cdot \overline{YLDPLUM}_{acro,bas,cty},\\
  \overline{SYSSHARE}_{aliv,bas,cty,cz,\mathrm{LG}}
  &= \frac{1}{1+\delta^{sys}_{aliv,bas,cty,cz,\mathrm{LG}}
     \cdot \overline{GDPPC}_{cty}^{-\rho^{sys}_{aliv,\mathrm{LG}}}},\\
  \overline{SYSSHARE}_{aliv,bas,cty,cz,\mathrm{MX}}
  &= 1-\overline{SYSSHARE}_{aliv,bas,cty,cz,\mathrm{LG}},\\
  \overline{ICL}_{aliv,cfeed,bas,cty,cz,sys}
  &= \overline{FEEDEFFICIENCY}_{aliv,bas,cty,cz,sys}
     \cdot \overline{FEEDSHARE}_{aliv,bas,cty,cz,sys}
     \\
  &\quad
     \cdot \overline{GRAINSHARE}_{aliv,cfeed,bas,cty,cz,sys}.
\end{align*}
...
\begin{align}
  ...
  &= QS_{aliv,bas,cty}
     ...
     \cdot \overline{SYSSHARE}_{aliv,bas,cty,cz,sys}
...
\begin{align}
  ...
  &\quad
     ...
     \bigl(
       ...
       \nonumber\\[-0.3em]
  &\quad
       \cdot \overline{ICL}_{aliv,cfeed,bas,cty,cz,sys}
     \bigr)
...
\begin{multline}
  QLAFR_{bas,cty} = QLPASN_{bas,cty}\\
  \cdot
  \frac{
    \delta^{\text{afr}}_{bas,cty}\, PLAFR_{bas,cty}^{\,\rho^{\text{afr}}_{bas,cty}}
  }{
...
\begin{multline}
  PLPASN_{bas,cty}^{\,\rho^{\text{pasn}}_{bas,cty}}
  \cdot \overline{QLPASNBASE}_{bas,cty}
  = \overline{PLPASNBASE}_{bas,cty}^{\,\rho^{\text{pasn}}_{bas,cty}}
  \\
  \cdot \left(
    \delta^{\text{cro}} PLCRO^{\rho^{\text{cro}}}
    + \delta^{\text{frs}} PLFRS^{\rho^{\text{frs}}}
    + \delta^{\text{gra}} PLGRA^{\rho^{\text{gra}}}
...
\begin{multline}
  ...
  \right)
  \\[-0.3em]
  \quad \cdot (1 + PLPASPROTCOMP_{bas,cty})
...
\begin{multline}
  ...
  \cdot \overline{QLFRSBASE}_{bas,cty}
  = \overline{PLFRSBASE}_{bas,cty}^{\,\rho^{\text{frs}}_{bas,cty}}
  \\
  \cdot \left(
...
\begin{align}
  PLPRIMF_{bas,cty}
  &= \Biggl[
    \overline{PLPRIMFBASE}_{bas,cty}
    + \max\!\Biggl(
        0,\,
        \overline{CARBONSTOCK}_{bas,cty}\cdot\frac{44}{12}
        \nonumber\\[-0.3em]
  &\qquad\qquad
        \cdot \overline{PRCCAR\_LND}_{bas,cty}
        \cdot dcffrs_{cty}
        - affcost_{cty}
      \Biggr)
  \Biggr]
  \nonumber\\[-0.3em]
  &\quad \cdot
  \frac{1 + PLPRIMFPROTCOMP_{bas,cty}}
       {1 + PLPRIMFCOMP_{bas,cty}}
...
\begin{align}
  PLSECDF_{bas,cty}
  &= \Biggl[
    \overline{PLSECDFBASE}_{bas,cty}
    + \max\!\Biggl(
        0,\,
        \overline{CARBONSTOCK}_{bas,cty}\cdot\frac{44}{12}
        \nonumber\\[-0.3em]
  ...
  \nonumber\\[-0.3em]
  &\quad \cdot
  \frac{1 + PLSECDFPROTCOMP_{bas,cty}}
       {1 + PLSECDFCOMP_{bas,cty}}
...
\begin{align}
  PLGRA_{bas,cty}
  &=
  \overline{PLGRA\_C}_{bas,cty}
  \cdot (1+PLGRAPROTCOMP_{bas,cty})
...
\begin{align}
  PLAFR_{bas,cty}
  &= \frac{\overline{PLAFR\_C}_{bas,cty}}
           {1+PLAFRCOMP_{bas,cty}}
  \tag{PLAFREQ}\label{eq:PLAFREQ}\\[0.4em]
  QLAFR_{bas,cty}
  &\le QLAFR^{t-1}_{bas,cty}
     + \overline{AFR\_PLANT\_MAX}\cdot\overline{QLPASNBASE}_{bas,cty}
  \nonumber\\[-0.3em]
  &\quad\perp\quad PLAFRCOMP_{bas,cty}\ge 0
  \tag{QLAFRLIMEQ}\label{eq:QLAFRLIMEQ}
\end{align}
...
\begin{align}
  ...
  \quad\perp\quad PLPRIMFPROTCOMP_{bas,cty}\ge0,
  \tag{QLPRIMFPROTEQ}\label{eq:QLPRIMFPROTEQ}\\
  QLSECDF_{bas,cty} &\ge \overline{QLPROT}_{bas,cty,\mathrm{secdf}}
  \quad\perp\quad PLSECDFPROTCOMP_{bas,cty}\ge0,
  \tag{QLSECDFPROTEQ}\label{eq:QLSECDFPROTEQ}\\
  QLGRA_{bas,cty} &\ge \overline{QLPROT}_{bas,cty,\mathrm{gra}}
  \quad\perp\quad PLGRAPROTCOMP_{bas,cty}\ge0,
  \tag{QLGRAPROTEQ}\label{eq:QLGRAPROTEQ}\\
  QLPAS_{bas,cty} &\ge \sum_{lu\_pas}\overline{QLPROT}_{bas,cty,lu\_pas}
  \quad\perp\quad PLPASPROTCOMP_{bas,cty}\ge0.
  \tag{QLPASPROTEQ}\label{eq:QLPASPROTEQ}
\end{align}
