...
logit function that balances total land area, and land shares are determined by relative land prices. The non-pasture land nest includes
cropland, forest, other natural land, and afforested land. Protected areas are represented as minimum areas for the corresponding land classes,
while the agro-ecological suitability constraint limits cropland expansion.
...
AIM-ALPHA can be linked with other AIM models. AIM-Hub provides socioeconomic, climate-policy, energy-crop, and carbon-price drivers; AFOLUB can provide land-based mitigation assumptions; and AIM-PLUM can return changes in basin-level crop yields resulting from spatial land-use allocation~\cite{fujimoriSSP3AIMImplementation2017,hasegawaNationalLandbasedClimate2025,hasegawaGlobalLanduseAllocation2017}.
