...
Asia-pacific Integrated Model - Agricultural Land-use Partial equilibrium model for Harmonized Analysis), a partial equilibrium model
for agriculture and land use. The document is organized as follows:
\begin{enumerate}[label=\arabic*)]
  \item Model Structure
  \item System of Equations
  \item Data Processing
  \item Parameter Estimation
  \item Model Calculation Flow and Execution Method
\end{enumerate}
...
as a high-resolution partial equilibrium model covering the agriculture and land-use sectors at national and subnational levels. 
