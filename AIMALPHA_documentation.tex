...
\affil{2}{Research Organization of Science and Technology, Ritsumeikan University, 1 Chome-1-1 Nojihigashi, Kusatsu, Shiga, Japan}
\affil{3}{Social Systems Division, National Institute for Environmental Studies, 16-2 Onogawa, Tsukuba, Ibaraki, 305-8506, Japan}\par
...
\section{Development Guidelines}\label{sec:development}
\input{inc_sections/8_development_guidelines}

\section{Update History}
\input{inc_sections/9_update_history}
